**Response 1:**
Uganda, Burkina Faso, Rwanda, and Mozambique successfully institutionalized joint planning and budgeting through performance and programme-based budgeting (PPBB), with Uganda's Output Budgeting Tool integrating budget formulation since 2007, Burkina Faso piloting PPBB in 1997 with participatory workshops, Rwanda aligning strategic plans by 2012, and Mozambique standardizing programmes via e-SISTAFE since 2008. Key enabling factors include strong political ownership, capacity building through training, legal frameworks like organic budget laws, integrated information systems, pilot-based phased implementation, and alignment with existing Medium-Term Expenditure Frameworks.

**Response 2:**
South Africa established cost-effective strategic coordination through the Minister's Committee on the Budget and Medium-Term Expenditure Committee involving the Presidency's Department of Planning, National Treasury, and sector ministries since the early 2000s, while Namibia created joint macro-fiscal projections and budget hearings between the National Planning Commission, Ministry of Finance, and line ministries, and Rwanda merged its Ministry of Finance and Economic Planning (MINECOFIN) with sector ministry focal points. The enabling factors for success were strong institutional frameworks, clear coordination mechanisms between key government entities, integrated fiscal planning processes, and unified execution alignment structures.
